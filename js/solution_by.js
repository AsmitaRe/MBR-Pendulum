document.getElementById("left").href = "algebra_by.html";
document.getElementById("right").href = "idealisation_vis.html";
...
function radiusChanger(i){
    ...
    bob_r_new = i;
    bob_area=Math.PI*bob_r*bob_r_new;
    bob_vol=1.33*Math.PI*bob_r*bob_r*bob_r_new;
    t = -dt;
}
